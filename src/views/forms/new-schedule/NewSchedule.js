...
function NewSchedule() {
    ...
    return (
        <div className="App">
          ...
          <h2 style={{ textAlign: "center" }}>New Schedule</h2>
        </div>
        <hr />
        <br />
            ...
            <div className="date-tabs">
                ...
                <DatePicker className="tabs" placeholderText="End Date" selected={newEvent.end} onChange={(end) => setNewEvent({ ...newEvent, end })} />
                </div>
                <button onClick={handleAddEvent} className="btn btn-primary save-btn schedule-btn">
                    Add Event
                </button>
            </div>
            <br />
